...
\begin{itemize}
 ...
 \item We will compute the different of the input growth rate with that in 
  the fiducial cosmology, $\Delta f_\star = f(z_\star) - f^0(z_\star)$, 
...
\AFR{Add here a discussion on units and Hubble expansion.}

\subsubsection{Equation above}

\AFR{I write below the equations deriving equation \ref{eq:growth} above.}
