...
either.
\pvm{You probably want to label it in Mpc, e.g., for mode consistency reasons
discussed above, 
...
\NEW{I'm very confused... If we store the flux power spectrum in comoving
units, we will need a Hubble parameter to compare the predictions with the
measured one...}
