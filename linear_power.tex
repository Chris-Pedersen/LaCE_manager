...
I will add a discussion here on how to go from the parameters describing the
linear power ($\beta$,$\Delta f_\star$) to predictions of the linear
power spectrum at different redshifts, in velocity units.

For now, I just copied comments that used to be in the Likelihood section.
