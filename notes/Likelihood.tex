...
\afrhid{\anze, this is an internal document, to make sure we are all (including
...
\begin{itemize}
 ...
 \item If we wanted the likelihood to be able to describe 3D clustering as well,
  ...
  \afrhid{as well as the sound horizon at the drag epoch describing BAO, $r_d$. 
...
\afrhid{For simplicity, we will restrict ourselves to models with a linear power
...
\afrhid{Yes, this is an option. But as Pat mentions below, this might not
...
\afrhid{Great, that's all I wanted to hear. For now, let's assume this is a 
...
\afrhid{Actually, I don't think at this point you can get any of the above.
...
\afrhid{Nooooooo! I need to understand how the final package will be used, 
before I can think of emulators and simulations!}

\afrhid{Pat, in your 2005 paper, you had $\chi^2$ look-up tables, that were only
...
\afrhid{Perfect. Just for the record, in my original text (two days ago) I never
...
\afrhid{Yes, \anze, that was the entire point of the user interface. 
...
propagated forward.}
\afrhid{My plan was to translate the flux power into linear power, in $\kms$, 
...
\afrhid{I never talked about doing this! Only \anze\ talked about it.
...
\afrhid{Of course! I learned a lot from this discussion the last week \smiley.}
...
\afrhid{Yes, I agree with the above.}
...
more for us.}
\afrhid{Ok, this is the type of discussion I wanted to have. 
...
\afrhid{Agreed. We should have an easy version for all to use, and a difficult
...
\afrhid{This is one of the pieces that is still not crystal clear in my head.
...
\afrhid{Yes, I got that. That's what I was trying to say here...}
...
\afrhid{Pat, that is what I was trying to write... See discussion below, about
