...
\afrhid{But I don't think I've got an answer to my question. 
...
\afrhid{Yes, I agree. I realize now that I was using the word \textit{emulator}
...
\afrhid{Just to be sure. $\theta$ parameters describe the different shape of the 
...
add $D_A(z=4)$ for 3D.) }
\afrhid{Ok, I think we are getting closer. I think part of the confusion was 
