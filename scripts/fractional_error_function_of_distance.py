...
for aa, emulator in enumerate(emu.emulators):
    ...
    plt.scatter(distances,frac_error,s=1,label=r"z=%.2f, $\sigma^2_\mathrm{RBF}=%.3f$, $\sigma^2_\mathrm{linear}=%.3f$, $l_\mathrm{RBF}=%.3f$" % (emu.zs[aa],sigma_rbf,sigma_linear,lengthscale))
